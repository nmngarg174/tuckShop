...
<?php
	...
	$sql1=("SELECT * 
FROM  `cart_offline` c, registration r
WHERE CURDATE( ) = CAST( c.cdate AS DATE ) 
AND c.email = r.email "); 
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background:url(thaparImg/hostelj.jpg); background-size:cover; background-repeat:no-repeat; " >
...
<table class='table table-hover' id='mytable' cellspacing="0" style="position:relative; top:10px;">
<thead>
<tr> 	
    <th>Name</th>
    <th>Email</th>
