...
//	echo $t1; 
	...
	$t5=234500; 
        ...
        //$t4=000001;   
        //$t5=230003;
                                                                $mysqlNM=new mysqli('localhost','tuck','1234561','tuck'); 
                                  
								$query='select status from retailer where name="naman"';   
								$result=$mysqlNM->query($query);
...
/*	
	if(($t1<=$t3 && $t1>=$t2) || ($t1<=$t5 && $t1>=$t4) && ($val==1)){
                                // after checking the time check the status of the website here 
      ...
      <ul class="side-nav" id="mobile-demo">
        ...
        <li><a href="logout.php">Log-Out</a></li>
		  ...
		  <div>
                ...
                <p>J Hostel Cart</p>
                <p><?php echo $_SESSION['namEmail'] ?></p>
