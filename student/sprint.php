...
session_start(); 
	...
	$sql1='insert into cart_offline(bill,cdate,email) values('.$_SESSION['totalPrice'].',"'.date('Y-m-d H:i:s',$time).'","'.$_SESSION['name'].'")';
	...
	$sql2='insert into productoffline(cid,id,quantity) values('.$i.','.$id.','.$_SESSION['cart'][$id]['quantity'].')';
