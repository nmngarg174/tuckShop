<?php
	...
	// echo $limit;  
	$sqlNew='select * from cart_offline where status=0 order by price desc $limit ';
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php
					...
					$sqlOrder="select p.*,c.bill from product_offline p,cart_offline c where c.oid='".$row[5]."'  and p.oid='".$row[5]."'"; 
				 	//echo $sqlOrder1; 
